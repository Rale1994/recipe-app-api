...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(user=self.user, title='Sample recipe title', link='https//example.com/recipe.pdf',
    ...
    def test_recipe_other_users_recipe_error(self):
        ...
        new_user = create_user(email='new_user@example.com', password='newpass1123')
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test creating recipe wit existing ingredient."""
