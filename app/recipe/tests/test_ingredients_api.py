...
def detail_url(ingredient_id):
    """Create and return an ingredient ulr"""
...
class PrivateIngredientApiTest(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        user2 = create_user(email="user2@example.com", password='pass2123')
    ...
    def test_filter_ingredient_assigned_to_recipes(self):
        ...
        recipe = Recipe.objects.create(title='Apple Crumbel', time_minutes=5, price=Decimal('4.50'), user=self.user)
